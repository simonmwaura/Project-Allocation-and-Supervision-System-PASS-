...
const DeclinePitchModal = ({ 
  ...
  const handleConfirm = () => {
    // Pass the typed reason back to the parent component when confirming
    onConfirm(reason);
    setReason(""); // Reset the field after confirming
  };
    ...
    <div className="fixed inset-0 z-50 bg-black/20 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-[15px] font-semibold text-gray-500 mb-4 leading-relaxed">
          Are you sure you want to decline this project pitch from {studentName}? <br />
        ...
        <div className="w-full flex flex-col mb-8">
          <label className="text-sm font-medium text-gray-500 mb-1">
            Project idea decline
          </label>
          <textarea
            value={reason}
            onChange={(e) => setReason(e.target.value)}
            placeholder="Reason for rejecting the pitch"
            rows={4}
        ...
        <div className="flex gap-4 w-full justify-center">
          ...
          <button
            ...
            disabled={reason.trim() === ""} // Optional: Disable button if they haven't typed a reason
