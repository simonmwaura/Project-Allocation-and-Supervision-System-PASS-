...
const NoFacultyFound = () => {
  return (
    ...
    >
      <h3 className="text-2xl md:text-3xl font-extrabold mb-6">No Supervisors Found</h3>

      <div className="mb-8">
        <FiFileText size={80} strokeWidth={1.5} />
      </div>

      <p className="text-base md:text-lg font-semibold leading-relaxed mb-10 px-4">
        There are currently no supervisors in the system. Please upload the official university CSV file to populate the faculty registry.
      </p>
