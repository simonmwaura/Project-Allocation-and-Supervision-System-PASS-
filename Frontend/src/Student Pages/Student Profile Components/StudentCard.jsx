...
const StudentCard = ({ studentData, setStudentData, fullName }) => {
  ...
  return (
    <div
      className="bg-white p-8 rounded-2xl shadow-sm border-2 flex flex-col items-center text-center w-full"
        ...
        <div className="flex flex-col space-y-2 pt-2">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              disabled={isSaving}
              className="px-4 py-2 text-white rounded-lg transition hover:opacity-90 flex items-center justify-center shrink-0 disabled:opacity-50"
